...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
     ...
     <!--   <div class="flex-w flex-m">
            ...
            <a href="" style="padding: 10px;color: black">7400400933</a>
        ...
        <div class="flex-w flex-m">
            ...
            <a href="" style="padding: 10px;color: black">omjaiswal@techfest.org</a>
        ...
        <div>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">Pratik Phule</a>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">7038560585</a>
            ...
            <div style="height: 36px">
                ...
                <a href="" style="padding: 10px;color: black">pratik@techfest.org</a>
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('/2019/summit.jpg');">
    </div>
</div>
