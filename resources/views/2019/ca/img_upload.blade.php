...
<body>
<div >
    <form action="{{url()->current()}}" class="dropzone" method="post">
        {{--<form action="/imgupload/{{$id}}" class="d ropzone" method="post">--}}
        {{csrf_field()}}
        <div class="fallback">
...
<div>
    <a href="https://techfest.org/dashboard" class="w3-button w3-green">Go back to Dashboard</a>
</div>
