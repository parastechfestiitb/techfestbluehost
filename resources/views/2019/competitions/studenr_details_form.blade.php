...
<div class="container-contact100">
    ...
    <div class="wrap-contact100">
        <form class="contact100-form validate-form" method="post" action="/2019/competitions/details_form">
            {{csrf_field()}}
            ...
            <div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
                <input class="input100" type="number" name="phone" placeholder="Phone" value="{{$current_user_data->number}}" required max="9999999999" min="1000000000">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
                <input class="input100" type="text" name="college_name" placeholder="College Name" value="{{$current_user_data->college}}" required>
                <span class="focus-input100"></span>
            </div>
{{--            <div class="wrap-input100 validate-input" data-validate = "Please enter your phone">--}}
...
{{--            </div>--}}
            <div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
                <input class="input100" type="number" name="college_pincode" placeholder="College Pincode" value="{{$current_user_data->pincode}}" required>
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
                <input class="input100" type="number" name="college_year" placeholder="Year of study(1,2,3,4,5)" value="{{$current_user_data->year}}" required>
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
                <input class="input100" type="text" name="student_address" placeholder="Home Address" value="{{$current_user_data->address}}" required>
                <span class="focus-input100"></span>
            </div>
